...
public class MainActivity extends AppCompatActivity {
    ...
    // This is where the app first loads. It should call the fragment that contains
    // the login UI
    @Override
    ...
    public void onGetUserProfileClicked() {
        if (mAccessToken == null) {
            Toast.makeText(this, "You need to get an access token first!",
    ...
    private AuthorizationRequest getAuthenticationRequest(AuthorizationResponse.Type type) {
        return new AuthorizationRequest.Builder(CLIENT_ID, type, getRedirectUri().toString())
                .setShowDialog(false)
                .setScopes(new String[] { "user-read-email user-top-read " }) // <--- Change the scope of your requested
                                                                              // token here
